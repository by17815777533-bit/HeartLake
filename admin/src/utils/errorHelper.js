...
/**
 * 根据业务错误码获取用户友好提示
 * @param {number} code - 后端业务错误码
 * @returns {string|undefined} 匹配到的提示，未匹配返回 undefined
 */
export function getBusinessMessage(code) {
 ...
 * @param {Error|Object} error - 错误对象（可携带 _businessCode 属性）
