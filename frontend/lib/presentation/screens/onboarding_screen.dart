    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(data.subtitle, style: TextStyle(fontSize: 18, color: Colors.white.withOpacity(0.8))),
          const SizedBox(height: 24),
          Text(data.description, textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Colors.white.withOpacity(0.7), height: 1.6)),
        ],
      ),
    );
  }
  ...
  Widget _buildIndicator() {
    return Row(
      ...
      children: List.generate(_pages.length, (i) => AnimatedContainer(
        ...
        height: 8,
        decoration: BoxDecoration(
          color: _currentPage == i ? _pages[i].color : Colors.white.withOpacity(0.3),
