...
void main() {
  group('MoodColors.fromString (DiscoverScreen mood list)', () {
    ...
    test('should map 感恩 to MoodType.neutral (no dedicated type)', () {
      // 感恩 没有专门的 MoodType，应该 fallback 到 neutral
      expect(MoodColors.fromString('感恩'), MoodType.neutral);
    });

    test('should map 期待 to MoodType.neutral (no dedicated type)', () {
      // 期待 没有专门的 MoodType，应该 fallback 到 neutral
      expect(MoodColors.fromString('期待'), MoodType.neutral);
    });
  ...
  group('MoodColors.allMoods', () {
    test('should return all 8 mood types', () {
